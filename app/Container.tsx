    ...
    <div className="relative w-10/12 pt-4 mx-auto lg:pt-16">
        <div className='flex-row-reverse items-center justify-between md:flex'>
            ...
            <div className='p-4 pl-0 mt-5 sm:mt-20'>
                ...
                <h1 className='pt-2 text-4xl sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl lg:pt-6'>I&apos;m Ali<p className='py-4 text-xl sm:text-2xl md:text-xl lg:text-2xl xl:text-3xl'>A Frontend Developer </p></h1>
                ...
                <div className='flex items-center mt-6 md:mt-14'>
                    <ul className='flex items-center my-4 mr-6 space-x-2 sm:space-x-5 '>
                        ...
                        <li><Link href="https://www.linkedin.com/in/ali-al-dhamen-323a04144" target="_blank" rel="noreferrer" className='transition duration-150 ease-in opacity-75 hover:opacity-100'><AiOutlineLinkedin size={24}/></Link></li>
