        ...
        <div className='grid grid-cols-1 mt-20 lg:grid-cols-3 sm:grid-cols-2 sm:gap-10'>
            <a href="" className='border-[0.5px] border-neutral-500 block rounded-2xl my-6'>
                <div className='w-full py-8 text-center bg-neutral-800 rounded-t-2xl'>
                    <img className='max-w-[80px] rounded-2xl mx-auto brightness-90 contrast-125' src="fire.png" alt="" />
                </div>
            ...
            <a href="" className='border-[0.5px] border-neutral-500 block rounded-2xl my-6'>
                <div className='w-full py-8 text-center bg-neutral-800 rounded-t-2xl'>
                    <img className='max-w-[80px] rounded-2xl mx-auto brightness-90 contrast-125' src="flutter.png" alt="" />
                </div>
                <div className='p-8 py-10'>
                    <h1 className='mb-1 font-bold'>Flutter</h1>
                    <p className='text-neutral-400'>For Creating Mobile User-Friendly Interfaces </p>
                </div>
            </a>
            <a href="" className='border-[0.5px] border-neutral-500 block rounded-2xl my-6'>
                <div className='w-full py-8 text-center bg-neutral-800 rounded-t-2xl'>
                    <img className='max-w-[80px] rounded-2xl mx-auto brightness-90 contrast-125' src="react.png" alt="" />
                </div>
                <div className='p-8 py-10'>
                    <h1 className='mb-1 font-bold'>React</h1>
                    <p className='text-neutral-400'>For Creating Interactive User-Friendly Interfaces </p>
                </div>
            </a>
            <a href="" className='border-[0.5px] border-neutral-500 block rounded-2xl my-6'>
                <div className='w-full py-8 text-center bg-neutral-800 rounded-t-2xl'>
                    <img className='max-w-[80px] rounded-2xl mx-auto brightness-90 contrast-125' src="supabase.png" alt="" />
                </div>
                <div className='p-8 py-10'>
