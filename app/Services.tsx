    ...
    <div className='w-10/12 mx-auto'>
        ...
        <div className='flex justify-between max-md:flex-wrap gap-7'>
            <div className='p-5 mt-5 overflow-hidden md:w-1/3 d relativ'>
                ...
                <p className='mt-10 text-center mb-7'><a href="#projects" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-pink-600'>know more</a></p>
            ...
            <div className='p-5 mt-5 overflow-hidden md:w-1/3 d relativ'>
                ...
                <p className='mt-10 text-center mb-7'><a href="#projects" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-blue-600'>know more</a></p>
                <span className='w-[60px] h-[60px] z-[-2] blur-[100px] left-[45%] bg-white absolute top-0 '></span>
            ...
            <div className='p-5 mt-5 overflow-hidden md:w-1/3 d relativ'>
                ...
                <p className='mt-10 text-center mb-7'><a href="#projects" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-yellow-500'>know more</a></p>
                <span className='w-[60px] h-[60px] z-[-2] blur-[100px] left-[45%] bg-white absolute top-0 '></span>
